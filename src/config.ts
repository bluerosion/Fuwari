...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://api.elaina.cat/random/", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	background: {
		...
		src: "https://api.elaina.cat/random/", // Background image URL (supports HTTPS)
