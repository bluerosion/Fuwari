...
description: 此指南将教你如何从零开始选择并搭建你想要的qq机器人
...
此框架`通常`为修改qq客户端或模拟安卓qq协议，将qq的功能以特定的协议暴露出来，通常可以通过其它框架（如koishi，astrbot）对接其使用的协议（通常为onebot）
...
通俗点开讲就是将qq的接口按照某种协议（即onebot）开放给开发者与其他框架使用，但是napcat调用的是更加底层的node模块

### Lagrange（历史最强！）

![[../assets/images/qqbot-part1_2.webp]]



### Mirai及其衍生框架（我去，老资历！）

![[../assets/images/qqbot-part1_3.png]]
